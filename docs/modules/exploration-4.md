...
- [ANES 2020 Full Codebook](https://sda.berkeley.edu/sdaweb/docs/nes2020full/DOC/hcbk.htm)
...
- [Pandas User Guide](https://pandas.pydata.org/docs/user_guide/index.html): in-depth explanations of data operations  
- [Matplotlib Documentation](https://matplotlib.org/): visualization concepts and examples  
- [Data Visualization Catalogue](https://datavizcatalogue.com/): choosing the right plot for your question  

<!-- !!! note "Recommended practice" -->
<!--     Revisit these resources throughout the semester. Data exploration is not a one-time step—it is an iterative process. -->
